 ...
 */
public class DetailPageFileGenerator extends FileGenerator {

	public static final String TEMPLATE = "detail.vm";
	
	public DetailPageFileGenerator(GenerationInformation generationInformation) {
	...
	public File getFile(Entity entity) {
		return new File(getDirectory(entity), "detail.jsp");
	}
