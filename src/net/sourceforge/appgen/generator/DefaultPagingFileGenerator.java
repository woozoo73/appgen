 ...
 */
public class DefaultPagingFileGenerator extends OnceFileGenerator {

	public static final String TEMPLATE = "paging.jsp";
	
	public DefaultPagingFileGenerator(GenerationInformation generationInformation) {
	...
	public File getFile(Entity entity) {
		return new File(getDirectory(), "default.jsp");
	}

	@Override
	public File getDirectory() {		
		return new File(outputDir.getPath() + File.separator + "WebContent" + File.separator + "WEB-INF" + File.separator + "jsp" + File.separator + "include" + File.separator + "paging");
	}
