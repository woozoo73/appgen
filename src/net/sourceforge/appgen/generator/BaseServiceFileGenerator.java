...
public class BaseServiceFileGenerator extends OnceFileGenerator {
	...
	public File getFile(Entity entity) {
		BaseService baseService = new BaseService(packageName);
		
		return new File(getDirectory(), baseService.getClassName() + ".java");
	}
	...
	public File getDirectory() {
		...
		return new File(outputDir.getPath() + File.separator + "src" + File.separator + ConventionUtils.getPath(baseService.getFullPackageName()));
	}
