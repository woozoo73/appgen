 ...
 */
public class WritePageFileGenerator extends FileGenerator {

	public static final String TEMPLATE = "write.vm";
	
	public WritePageFileGenerator(GenerationInformation generationInformation) {
	...
	public File getFile(Entity entity) {
		return new File(getDirectory(entity), "write.jsp");
	}
