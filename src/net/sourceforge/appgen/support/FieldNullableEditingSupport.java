 ...
 */
public class FieldNullableEditingSupport extends EditingSupport {

	private CellEditor editor;

	public FieldNullableEditingSupport(ColumnViewer viewer) {
		super(viewer);
	...
	protected void setValue(Object element, Object value) {
		...
		try {
			boolean nullable = Boolean.parseBoolean(String.valueOf(value));
